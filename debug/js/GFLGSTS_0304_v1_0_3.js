    ...
    $("#Capture").on("click", function () {
        html2canvas(document.getElementById("PlanDetails")).then(function (canvas) {
            if (window.navigator.msSaveBlob) {
                ...
                link.target = "_blank";
                link.innerHTML = "png";
                var link = "<a href='" + canvas.toDataURL() + "' target='_blank'>png</a>";
                document.getElementById("Capture_png").innerHTML = link;
                // link.click();
                //test
